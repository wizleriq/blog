...
const text = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc id purus sit amet tortor feugiat maximus. Cras semper nulla nisl, quis faucibus turpis eleifend eget. Nulla dictum eget felis pretium dignissim. Duis ut leo velit. Pellentesque et aliquet ex. Vestibulum velit arcu, rhoncus at tristique vitae, hendrerit a nisl.";

const truncatedText = expanded ? text : text.slice(0, 50) + "...";
...
<p className="text-s text-gray-700 items-center leading-7 mt-4">
  {truncatedText}
</p>

<span className="dot-icon" onClick={toggleExpanded}>...</span>
        </div>
      </div>
